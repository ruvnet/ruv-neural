...
| [0015](0015-neurosleep-qeeg-export.md) | Signed NeuroSleep qEEG phenotype export |
| [0016](0016-neural-foundation-models.md) | Neural foundation-model embeddings (optional, pluggable backend) |
| [0017](0017-invasive-bci-boundary.md) | Invasive BCI landscape & the non-invasive scope boundary (interop, not parity) |
| [0018](0018-opm-meg-frontend.md) | Wearable OPM-MEG front-end (driver abstraction) |
| [0019](0019-nv-diamond-roadmap.md) | NV-diamond quantum magnetometry: aspirational front-end, honest MEG gap |
| [0020](0020-genus-evidence-base.md) | Clinical evidence base for 40 Hz GENUS & claims discipline |
| [0021](0021-therapeutic-neuromod-out-of-scope.md) | Adaptive/closed-loop *therapeutic* neuromodulation is out of scope |
| [0022](0022-privacy-preserving-personalization.md) | Privacy-preserving, on-device & federated personalization |
| [0023](0023-neural-data-governance.md) | Neural-data governance & neurorights compliance |
| [0024](0024-ruvector-backend.md) | RuVector as the embedding store, ANN retrieval & inference backend |

> ADRs 0016–0024 form the **emerging-medical-breakthroughs research series**:
...
> privacy-preserving learning, neural-data governance, and the RuVector
> embedding backend) while staying inside
