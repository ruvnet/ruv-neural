...
// Generated by metaharness — the `ruv-neural-harness` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx ruv-neural-harness`
...
// "bin" + "files" fields in package.json), so `npx ruv-neural-harness` works the moment
...
const HARNESS_NAME = 'ruv-neural-harness';

/** `ruv-neural-harness init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `ruv-neural-harness doctor` — verify the install end-to-end (kernel + host resolve). */
