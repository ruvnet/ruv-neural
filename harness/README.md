...
Governed agent harness for the ruv-neural Rust workspace: edge-first neural signal processing (EEG/MEG DSP, embeddings, closed-loop stimulation with safety envelope, brain-to-text, NeuroSleep qEEG)
...
```bash
npm install -g ruv-neural-harness
ruv-neural-harness init
ruv-neural-harness doctor
```
